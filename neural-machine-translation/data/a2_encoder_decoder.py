...
class DecoderWithMultiHeadAttention(DecoderWithAttention):
    ...
    def attend(
        ...
        c_t_n = super().attend(htilde_t, h, source_x_lens_multi)
        #print(f'c_t_n:{c_t_n.shape}')
        # reshape back
        c_t_n = c_t_n.view(-1, self.hidden_state_size)
        #print(f'c_t_n:{c_t_n.shape}\n')
...
class EncoderDecoder(EncoderDecoderBase):
    ...
    def translate(self, input_sentence):
        ...
        # 3. Feed the tokenized sentence into the model.
        token_id_list = [self.dataset.source_word2id[i] for i in token_list]
